...
namespace HRLibUnitTest
{
    ...
    public class UnitTestPersonnel
    {
        ...
        public void TestMethodInfoEmployee() 
        {
            ...
            Employee empl7  = new Employee("Vasilis Kafes",           "2601010101",        "6975522897",       "2001-a1-p8",           "2020-01-05");
            Employee empl8  = new Employee("Sotiris Kaselakis",       "2601010801",        "6973298777",       "2001-01-07",           "2019-o5-k8");
            Employee empl9  = new Employee("Antonis Kazaglhs",        "2102322751",        "6978899987",       "13-02-2001",           "2021-05-02");
            Employee empl10 = new Employee("Katerina Vossoy",         "2105042087",        "6987304875",       "2001-07-11",           "01-09-2022 ");
            ...
            Employee empl13 = new Employee("Razvan Lucescu",          "2701010102",        "6935660423",       "1950-09-25",           "1970-04-08");
            Employee empl14 = new Employee("Despoina Soukera",        "2501010101",        "6990101010",       "2007-12-01",           "2023-08-01");
            Employee empl15 = new Employee("Pavlos Papazoglou",       "2501010102",        "6988558589",       "1957-05-30",           "1977-02-03");
            Employee empl16 = new Employee("Andraz Sporar",           "2104588989",        "6999999999",       "2007-01-02",           "2023-01-02");
            ...
            object[,] testcases =
            {
             ...
             //                                    της InfoEmployee() στην Age     της InfoEmployee() στην YearsOfExperience              
                ...
                { "9",          empl9,                          -1,                                     3,                                 "[4.3] Το μορφότυπο της ημερομηνίας πρέπει να είναι ΧΧΧΧ-ΜΜ-ΗΗ"},
                ...
                { "Fault1",     empl15,                         66,                                    47,                                 "Έγκυρη ηλικία και ημερομηνία πρόσληψης "},
                { "Fault2",     empl16,                         17,                                     1,                                 "Έγκυρη ηλικία και ημερομηνία πρόσληψης "},
