        ...
        public void TestMethodInfoEmployee() 
        {
            ...
            object[,] testcases =
            {
             ...
             //                                                της InfoEmployee() στην Age     της InfoEmployee() στην YearsOfExperience              
                ...
                { "YearOfXpError_7",     emplfault2,                     37,                                    20,                                 "[6]   Η ημερομηνία πρόσληψης πρέπει να είναι από την ημερομηνία γέννησης μεταγενέστερα κατά 18 χρόνια εώς την τρέχουσα ημερομηνία"},
