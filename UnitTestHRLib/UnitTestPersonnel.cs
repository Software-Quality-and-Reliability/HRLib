        ...
        public void TestMethodCheckPhone() /* TIGER */
        {
            ...
            object[,] testcases =
            {
             ...
             //                                της CheckPhone() στην TypePhone    της CheckPhone() στην InfoPhone   
                ...
                { 9,      "2001010101",                        0,                                   "",                                         "Έγκυρο σταθερό τηλέφωνο" },
                ...
                { 18,     "2901010101",                        0,                                   "",                                         "Έγκυρο σταθερό τηλέφωνο" },
                { 19,     "6900101010",                        1,                                 "Nova",                                       "Έγκυρο κινητό τηλέφωνο με εταιρία κινητής τηλεφωνίας τη Nova"},
                { 20,     "6910101010",                        1,                                   "",                                         "Έγκυρο κινητό τηλέφωνο"},
                { 21,     "6920101010",                        1,                                   "",                                         "Έγκυρο κινητό τηλέφωνο"},
                ...
                { 25,     "6960101010",                        1,                                   "",                                         "Έγκυρο κινητό τηλέφωνο"},
