...
namespace HRLibUnitTest
{
    ...
    public class UnitTestPersonnel
    {
        ...
        public void TestMethodInfoEmployee() 
        {
            ...
            Employee empl2 = new Employee("Vasilis Athaniasiou",   "1201010101",        "6980101010",       "1999-07-15",                    "2020-08-15");
            Employee empl3 = new Employee("Evangelos Tsimentas",   "2701010101",        "7990101010",       "1990-03-04",                    "2015-06-03");
            Employee empl4 = new Employee("Omar Alhaz",            "2301010101",        "6970101010",       "2000@02@01",                     "2020-05-06");
            Employee empl5 = new Employee("Akrivh Krouska",        "2301110101",        "6970101011",       "2000-02-01",                     "2020@05@06");
            ...
            object[,] testcases =
            {
             ...
             //                                    της InfoEmployee() στην Age     της InfoEmployee() στην YearsOfExperience              
                ...
                { "2",          empl2,                          -1,                                    -1,                                 "[2] Το σταθερό τηλέφωνο να είναι έγκυρο     "},
                { "3",          empl3,                          -1,                                    -1,                                 "[3] Το κινητό τηλέφωνο να είναι έγκυρο      "},
                { "4",          empl4,                          -1,                                     3,                                 "[4.1] Η ημερομηνία πρέπει να περιλαμβάνει τον χαρακτήρα '-', '/' ακριβώς 2 φορές"},
                { "5",          empl5,                          24,                                    -1,                                 "[4.1] Η ημερομηνία πρέπει να περιλαμβάνει τον χαρακτήρα '-', '/' ακριβώς 2 φορές"},
