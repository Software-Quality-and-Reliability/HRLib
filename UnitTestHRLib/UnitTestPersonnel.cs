    ...
    public class UnitTestPersonnel
    {
        ...
        public void TestMethodValidName() 
        {
            ...
            //                                             επιστροφής της ValidName()                      
                ...
                { "NameError_1",    "Ακριβή Κρούσκα",             true,              "[2.6] Τα γράμματα πρέπει να είναι όλα λατινικά" },
            };
        ...
        { 
            ...
            //                                                  επιστροφής της ValidPassword()
                ...
                {"PasswordError_2",   "pao131908@123",                    true,                  "[6.1] Πρέπει να ξεκινάει από κεφαλαίο γράμμα"},
            };
        ...
        public void TestMethodEncryptPassword() 
        {
            ...
            //                                                       επιστροφής της EncryptPassword()
                ...
                { "EncryptPwError_3",   "George_!12525",                   "Ljtwljd&57:7:",                  "Λανθασμένη κρυπτογράφηση" }
            };
        ...
        public void TestMethodCheckPhone() 
        {
            ...
            object[,] testcases =
            {
             ...
             //                                                        της CheckPhone() στην TypePhone     της CheckPhone() στην InfoPhone   
                ...
                { "TypePhoneError_4",       "210 28 12 967",                      0,                     "Metropolitan Area of Athens - Piraeus",                  "[1] Να περιέχει μόνο αριθμούς" },
                { "InfoPhoneError_5",       "6968765123",                        -1,                                "Cosmote",                                     "[4.1] Να ανήκει σε εταιρία κινητής τηλεφωνίας" }
            };
        ...
        public void TestMethodInfoEmployee() 
        {
            ...
            object[,] testcases =
            {
             ...
             //                                                της InfoEmployee() στην Age     της InfoEmployee() στην YearsOfExperience              
                ...
                { "AgeError_6",          emplfault1,                     66,                                    47,                                 "[5]   Η ημερομηνία γέννησης πρέπει να είναι από 1958-01-01 εώς 2006-12-31"},
                { "YearsOfXpError_7",    emplfault2,                     37,                                    20,                                 "[6]   Η ημερομηνία πρόσληψης πρέπει να είναι από την ημερομηνία γέννησης μεταγενέστερα κατά 18 χρόνια εώς την τρέχουσα ημερομηνία"},
        ...
        public void TestMethodLiveInAthens() 
        {
            ...
            Employee[] emplsFault1 = new Employee[]
            {
                //           "Ονοματεπώνυμο",       "Σταθερό Τηλέφωνο",    "Κινητό Τηλέφωνο",    "Ημερομηνία Γέννησης",    "Ημερομηνία Πρόσληψης
                new Employee("George Theoxaris",      "2102625345",          "6971345456",           "2001-08-23",              "2023-07-03"),
                new Employee("Vasilis Athanasiou",    "2102324901",          "6981314145",           "2001-03-19",              "2024-01-02"),
                new Employee("Omar Alhaz",            "2201234681",          "6945678789",           "2001-03-24",              "2023-12-20")
            };
            ...
            object[,] testcases =
            {
             ...
             //                                                της LiveInAthens()              
                ...
                { "AthensError_8",      emplsFault1,                   3,                       "Υπάλληλοι που κατοικούν στην Αθήνα : 2" }
