...
namespace HRLibUnitTest
{
    ...
    public class UnitTestPersonnel
    {
        ...
        public void TestMethodInfoEmployee() 
        {
            ...
            Employee empl9  = new Employee("Antonis Kazaglhs",        "2102322751",        "6978899987",       "13-002-2001",          "2021-05-02");
            ...
            Employee empl16 = new Employee("Andraz Sporar",           "2104588989",        "6999999999",       "1987-01-02",           "2004-01-02");
            ...
            object[,] testcases =
            {
             ...
             //                                    της InfoEmployee() στην Age     της InfoEmployee() στην YearsOfExperience              
                ...
                { "Fault1",     empl15,                         66,                                    47,                                 "[5] Η ημερομηνία γέννησης πρέπει να είναι από 1958-01-01 εώς 2006-12-31"},
                { "Fault2",     empl16,                         17,                                    20,                                 "[6] Η ημερομηνία πρόσληψης πρέπει να είναι από την ημερομηνία γέννησης μεταγενέστερα κατά 18 χρόνια εώς την τρέχουσα ημερομηνία"},
