        ...
        public void TestMethodLiveInAthens() 
        {
            ...
            object[,] testcases =
            {
             ...
             //                                                της LiveInAthens()              
                ...
                { "3",                  empls3,                       -1,                       "[2] Η ημερομηνία γέννησης πρέπει να είναι έγκυρη σύμφωνα με τις παραδοχές υλοποίησης της InfoEmployee()" },
                { "4",                  empls4,                       -1,                       "[3] Η ημερομηνία πρόσληψης πρέπει να είναι έγκυρη σύμφωνα με τις παραδοχές υλοποίησης της InfoEmployee()" },
                { "5",                  empls5,                       -1,                       "[4] Το σταθερό τηλέφωνο πρέπει να είναι έγκυρο ως προς τον τύπο τηλεφώνου (TypePhone) σύμφωνα με τις παραδοχές υλοποίησης της CheckPhone()" },
                { "6",                  empls6,                       -1,                       "[5] Το σταθερό τηλέφωνο πρέπει να είναι έγκυρο ως προς τις πληροφορίες τηλεφώνου (InfoPhone) σύμφωνα με τις παραδοχές υλοποίησης της CheckPhone()" },
                { "7",                  empls7,                        4,                       "Υπάλληλοι που κατοικούν στην Αθήνα : 4" },

                { "faultEmpls8",        empls8,                        3,                       "Υπάλληλοι που κατοικούν στην Αθήνα : 2" }
